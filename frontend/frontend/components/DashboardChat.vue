<template>
  <div>
    <table class="w-full font-mono border rounded shadow-sm mt-5">
      <thead>
        <tr class="font-semibold text-left text-gray-900 bg-gray-100 uppercase">
    ...
    <form class="flex space-x-5 py-3">
      <input
        id="message"
        class="
          flex flex-1
